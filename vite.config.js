    ...
    build: {
      ...
      rollupOptions: {
        input: {
          ...
          '110mh': resolve(__dirname, 'events/110mh.html'),
          '100mh': resolve(__dirname, 'events/100mh.html'),
          '400mh': resolve(__dirname, 'events/400mh.html'),
          '300mh': resolve(__dirname, 'events/300mh.html'),
